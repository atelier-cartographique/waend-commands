...
function create(feature) {
    const geom = new Geometry_1.default.Geometry(feature);
    const props = lodash_1.default.omit(feature.properties || {}, 'id');
    ...
    if (('LineString' === geomType) || ('Polygon' === geomType)) {
        ...
        return createData.binder.setFeature(createData.uid, createData.gid, createData.lid, data, true);
    }
...
const handleFile = (file, options, resolve, reject) => {
    ...
    const creator = evt => {
        ...
        bluebird_1.default.reduce(features, (total, item, index, arrayLength) => {
...
function resolver(options) {
    return (resolve, reject) => {
        ...
        options.input.addEventListener('change', e => {
            ((() => {
                handleFile(options.input.files[0], options, resolve, reject);
            }))();
        }, false);
...
function importer() {
    ...
    return (new bluebird_1.default(resolver(options)));
}
exports.default = {
    name: 'import',
    command: importer
